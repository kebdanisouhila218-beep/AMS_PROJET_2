...
├── Phase1\_Analyse/          Analyse statistique du corpus (script + graphes + resultats)
└── Phase2/
...
Le detail de cette analyse (scripts, graphes de distribution) se trouve dans `Phase1\_Analyse/`.
...
|Transformer|Embedding(128) + Positional Encoding -> 2x TransformerBlock (4 tetes, d\_ff=256) -> Flatten -> Dense(93)|395 997|
